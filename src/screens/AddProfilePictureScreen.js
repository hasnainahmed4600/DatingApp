    ...
    return new Promise(resolve => {
      ...
      firebase
        ...
        .catch(error => {
          setLoading(false);
          setTimeout(() => {
            alert(IMLocalized("An has error occured, please try again."));
          }, 1000);
        });
    });
  };
  ...
  const addPhoto = () => {
    ImagePicker.openPicker({
      ...
      .catch(error => {
        ...
        setLoading(false);
        setTimeout(() => {
          alert(IMLocalized("An error has occured, please try again."));
        }, 1000);
      });
  };
...
AddProfilePictureScreen.navigationOptions = ({ screenProps, navigation }) => {
