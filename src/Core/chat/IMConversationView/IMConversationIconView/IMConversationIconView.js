...
function IMConversationIconView(props) {
  ...
  let firstAvatarUri = (participants.length > 0 && participants[0].profilePhoto && participants[0].profilePhoto.length > 0) ? participants[0].profilePhoto : defaultAvatar;
  let secondAvatarUri = (participants.length > 1 && participants[1].profilePhoto && participants[1].profilePhoto.length > 0) ? participants[1].profilePhoto : defaultAvatar;
