...
const _colorSet = {
  mainThemeBackgroundColor: "green",
  mainThemeForegroundColor: "#8CC63F",
...
const _iconSet = {
  ...
  Like: require("../assets/images/chirp.png"),
  ...
  schoolIcon: require("../assets/images/books-stack-of-three.png"),
  groupsIcon: require("../assets/images/group.png"),
  cohortIcon: require("../assets/images/educate-school-icon.png"),
  igIcon: require("../assets/images/instagram-logo.png"),
  ...
  capricon: require("../assets/images/Zodiac/capricon.png"),
